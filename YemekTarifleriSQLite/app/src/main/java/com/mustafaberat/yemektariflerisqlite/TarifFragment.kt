package com.mustafaberat.yemektariflerisqlite
...
class TarifFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            if (gelenBilgi.equals("menudengeldim")){
                ...
                val gorselSecmeArkaPlani = BitmapFactory.decodeResource(context?.resources,R.drawable.gorseltiklamaresmi)
    ...
    fun gorselSec(view:View){
        ...
        activity?.let {
            if (ContextCompat.checkSelfPermission(it.applicationContext,Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){ //izin verilmedi izin istememiz gerek
                requestPermissions(arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE),1)

            } else {
                //izin zaten verilmiş, tekrar istemeye gerek yok galeriye yönlendir.
